...
public class _572_另一棵树的子树 {
    public static void main(String[] args) {
        ...
        TreeNode root = TreeNodeUtils.buildTree(Arrays.asList(3, 4, 5, 1, null, 2));
        TreeNode subRoot = TreeNodeUtils.buildTree(Arrays.asList(3, 1, 2));
     ...
     */
    public void test() {
        TreeNode tree1 = TreeNodeUtils.buildTree(Arrays.asList(3, 4, 5, 1, null, 2, null));
        TreeNode tree2 = TreeNodeUtils.buildTree(Arrays.asList(3, 4, 5, null, 1, null, 2));
        TreeNode tree3 = TreeNodeUtils.buildTree(Arrays.asList(3, 4, 5, 1, null, null, 2));
        TreeNode tree4 = TreeNodeUtils.buildTree(Arrays.asList(3, 4, 5, null, 1, 2, null));
